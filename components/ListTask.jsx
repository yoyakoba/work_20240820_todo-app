...
export const Task = (props) => {
    ...
    return(
        <div>
        <div className={`py-1.5 inline-flex justify-between ${props?.isCompleted ? 'bg-[#02b520]':'bg-[#0a429c]'} ${!props?.isExtended ?'rounded-lg': 'rounded-t-lg'} w-full .text-secondary px-[5%]`}>
